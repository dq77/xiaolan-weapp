 ...
 * @LastEditTime: 2020-06-28 20:42:18
 */ 
...
export function getWindowHeight(showTabBar = true) {
  ...
  // console.log('页面高度', windowHeight, statusBarHeight, titleBarHeight)
  ...
  if (process.env.TARO_ENV === 'alipay') {
    ...
    return `${windowHeight - titleBarHeight + (showTabBar ? 0 : TAB_BAR_HEIGHT)}px`
  }
